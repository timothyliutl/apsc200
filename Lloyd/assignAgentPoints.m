function agentPoints = assignAgentPoints(agentPositions, commCells, sides,...
    partitions,rObs)
%replace x and y with the agentpositions later
...
%
%Partitions the graph into voronoi parts and assigns points within the
%observed region into each of these partitions
...
numAgents = length(agentPositions);
